...
public class CnosDBAggregate extends FunctionNode<CnosDBAggregateFunction, CnosDBExpression>
    ...
    public enum CnosDBAggregateFunction {
        ...
        MAX(CnosDBDataType.DOUBLE, CnosDBDataType.INT, CnosDBDataType.STRING, CnosDBDataType.TIMESTAMP, CnosDBDataType.UINT),
        MIN(CnosDBDataType.DOUBLE, CnosDBDataType.INT, CnosDBDataType.STRING, CnosDBDataType.TIMESTAMP, CnosDBDataType.UINT),
        ...
        SUM(CnosDBDataType.INT, CnosDBDataType.DOUBLE, CnosDBDataType.UINT),
